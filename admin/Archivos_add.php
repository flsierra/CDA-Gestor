...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO documentos (descripcion, fecha, soporte) VALUES (%s, %s, %s)",
...
'width=400,heigh=150,location=no,scrollbars=yes,mnubars=no,toolbars=no,resizable=yes,fullscreen=no, status=yes')
    ...
    <h1>Ingresar Registros RTM y EC</h1>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          <td width="93" align="right" nowrap="nowrap">Placa Vehiculo</td>
          <td width="220"><input type="text" name="descripcion" value="" size="32" required=""/></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Fecha(año,mes,dia)</td>
          <td><input type="text" name="fecha" value="" size="32" required=""/> </td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Adjuntar Registro RTM y EC</td>
          <td><input type="text" name="soporte" value="" size="32" required="" /><input type="button" name="button" id="button" value="Subir Archivo" onclick="javascpript:subirarchivo();"/></td>
        </tr>
        <tr valign="baseline">
